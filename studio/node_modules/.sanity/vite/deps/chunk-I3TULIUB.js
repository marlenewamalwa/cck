...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources8-24OV3BBI.js")
});
...
function getOrderingMenuItemsForSchemaType(context, typeName) {
  ...
  return !type2 || !("orderings" in type2) ? [] : (type2.orderings ? type2.orderings.concat(DEFAULT_ORDERING_OPTIONS) : DEFAULT_ORDERING_OPTIONS).map((ordering) => getOrderingMenuItem(context, ordering));
}
...
function useDiffViewState(t0) {
  ...
  const mode = t2, anyParamSet = [previousDocument, nextDocument, mode].some(_temp$L), previousState = (0, import_react3.useRef)(void 0), t3 = previousDocument ?? "", t4 = nextDocument ?? "", t5 = mode ?? "";
  let t6;
  ...
  let t8;
  $[15] !== anyParamSet || $[16] !== onParamsError || $[17] !== params ? (t8 = [anyParamSet, onParamsError, params], $[15] = anyParamSet, $[16] = onParamsError, $[17] = params, $[18] = t8) : t8 = $[18], (0, import_react3.useEffect)(t7, t8);
  let t9;
  bb0: {
  ...
  }, t11 = [onActiveChanged, state2], $[22] = onActiveChanged, $[23] = state2, $[24] = t10, $[25] = t11) : (t10 = $[24], t11 = $[25]), (0, import_react3.useEffect)(t10, t11);
  let t12, t13;
  ...
  }, t13 = [onTargetDocumentsChanged, state2], $[26] = onTargetDocumentsChanged, $[27] = state2, $[28] = t12, $[29] = t13) : (t12 = $[28], t13 = $[29]), (0, import_react3.useEffect)(t12, t13);
  let t14, t15;
  return $[30] !== state2 ? (t14 = () => {
    previousState.current = state2;
  }, t15 = [state2], $[30] = state2, $[31] = t14, $[32] = t15) : (t14 = $[31], t15 = $[32]), (0, import_react3.useEffect)(t14, t15), state2;
}
...
var VersionMenuItem = (t0) => {
  ...
  let t9;
  $[33] !== formatPublishDate || $[34] !== release ? (t9 = release.metadata.releaseType === "scheduled" && (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: formatPublishDate(release) }), $[33] = formatPublishDate, $[34] = release, $[35] = t9) : t9 = $[35];
  let t10;
  $[36] !== t7 || $[37] !== t8 || $[38] !== t9 ? (t10 = (0, import_jsx_runtime3.jsxs)(Stack, { flex: 1, paddingY: 2, paddingRight: 2, space: 2, style: t3, children: [
    t7,
    t8,
    t9
  ] }), $[36] = t7, $[37] = t8, $[38] = t9, $[39] = t10) : t10 = $[39];
  let t11;
  $[40] !== release ? (t11 = isReleaseScheduledOrScheduling(release) && (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(LockIcon, {}) }) }), $[40] = release, $[41] = t11) : t11 = $[41];
  let t12;
  $[42] !== t11 ? (t12 = (0, import_jsx_runtime3.jsx)(Flex, { flex: "none", children: t11 }), $[42] = t11, $[43] = t12) : t12 = $[43];
  let t13;
  $[44] !== t10 || $[45] !== t12 || $[46] !== t2 ? (t13 = (0, import_jsx_runtime3.jsxs)(Flex, { gap: 1, children: [
    t2,
    t10,
    t12
  ] }), $[44] = t10, $[45] = t12, $[46] = t2, $[47] = t13) : t13 = $[47];
  let t14;
  return $[48] !== isSelected || $[49] !== onClick || $[50] !== t13 ? (t14 = (0, import_jsx_runtime3.jsx)(MenuItem, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: t13 }), $[48] = isSelected, $[49] = onClick, $[50] = t13, $[51] = t14) : t14 = $[51], t14;
};
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id2 || $[4] !== syncChannel) {
    ...
    $[6] !== id2 ? (t32 = (t4) => {
      ...
      return source !== id2;
    }, $[6] = id2, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(distinctUntilChanged(_temp$I), filter(t32), map(_temp2$j)), $[3] = id2, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = (0, import_react3.useState)(_temp$H);
  let t2;
...
var DiffViewDocumentLayout = (t0) => {
  ...
  let t5;
  $[10] !== documentId || $[11] !== isActive ? (t5 = isActive && (0, import_jsx_runtime3.jsx)(DiffView, { documentId }), $[10] = documentId, $[11] = isActive, $[12] = t5) : t5 = $[12];
  let t6;
  return $[13] !== children || $[14] !== t5 ? (t6 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    children,
    t5
  ] }), $[13] = children, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
};
function documentIdsToVariantTypes(ids) {
  return ids.filter((id2) => typeof id2 == "string").map(getDocumentVariantType);
}
...
var Pane = (0, import_react3.forwardRef)(function(props, forwardedRef) {
  ...
  if ($[10] !== panes || $[11] !== rootElement) {
    ...
    pane = $[12], t2 = $[13];
  const paneIndex = t2, nextPane = typeof paneIndex == "number" ? panes[paneIndex + 1] : void 0, isLast = paneIndex === panes.length - 1, expanded = expandedElement === rootElement, collapsed = layoutCollapsed ? false : pane?.collapsed || false, nextCollapsed = nextPane?.collapsed || false, ref = (0, import_react3.useRef)(null), flex = pane?.flex ?? flexProp, currentMinWidth = pane?.currentMinWidth ?? currentMinWidthProp, currentMaxWidth = pane?.currentMaxWidth ?? currentMaxWidthProp;
  let t3;
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react3.useState)(_temp$G), [rootElement, setRootElement] = (0, import_react3.useState)(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function useDocumentPaneInfo() {
  const documentPaneInfo = (0, import_react3.useContext)(DocumentPaneInfoContext);
  if (!documentPaneInfo)
...
var DocumentOperationResults = (0, import_react3.memo)(function() {
  const $ = (0, import_compiler_runtime2.c)(13), {
    ...
    documentId,
    documentType
  } = useDocumentPaneInfo(), documentTitleInfo = useDocumentTitle(), titleError = documentTitleInfo.error, event = useDocumentOperationEvent(documentId, documentType), prevEvent = (0, import_react3.useRef)(event), paneRouter = usePaneRouter(), {
    t: t2
  } = useTranslation(structureLocaleNamespace), {
    handleOpenDialog
  } = useDocumentLimitsUpsellContext();
  ...
  return $[5] !== documentTitle || $[6] !== event || $[7] !== handleOpenDialog || $[8] !== paneRouter || $[9] !== pushToast || $[10] !== t2 ? (t3 = () => {
    ...
    return event.type === "success" && !IGNORE_OPS.includes(event.op) && pushToast({
      closable: true,
      status: "success",
      title: (0, import_jsx_runtime3.jsx)(Translate, { context: event.op === "publish" && event.idPair.versionId ? "publishVersion" : event.op, i18nKey: "panes.document-operation-results.operation-success", t: t2, values: {
        op: event.op,
        title: documentTitle
      }, components: {
        Strong: "strong"
...
function DocumentInspectorPanel(props) {
  ...
  let t1;
  $[3] !== Component2 || $[4] !== documentId || $[5] !== documentType || $[6] !== handleClose ? (t1 = (0, import_jsx_runtime3.jsx)(DivergencesProvider, { enabled: false, children: (0, import_jsx_runtime3.jsx)(Component2, { onClose: handleClose, documentId, documentType }) }), $[3] = Component2, $[4] = documentId, $[5] = documentType, $[6] = handleClose, $[7] = t1) : t1 = $[7];
  const element = t1;
...
function InsufficientPermissionBanner(t0) {
  ...
  let t5;
  $[10] !== requiredPermission || $[11] !== t3 || $[12] !== t32 || $[13] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime3.jsx)(Translate, { t: t3, i18nKey: "banners.permission-check-banner.missing-permission", components: t32, values: t4, context: requiredPermission }) }), $[10] = requiredPermission, $[11] = t3, $[12] = t32, $[13] = t4, $[14] = t5) : t5 = $[14];
  let t6;
  ...
  let t7;
  $[21] !== t5 || $[22] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Banner, { content: t5, action: t6, "data-testid": "permission-check-banner", icon: ReadOnlyIcon }), $[21] = t5, $[22] = t6, $[23] = t7) : t7 = $[23];
  let t8;
  $[24] !== setShowRequestPermissionDialog || $[25] !== showRequestPermissionDialog ? (t8 = showRequestPermissionDialog && (0, import_jsx_runtime3.jsx)(RequestPermissionDialog, { onClose: () => setShowRequestPermissionDialog(false), onRequestSubmitted: () => {
  ...
  let t9;
  return $[27] !== t7 || $[28] !== t8 ? (t9 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t7,
    t8
...
function DocumentNotInReleaseBanner(t0) {
  ...
  let t13;
  return $[38] !== t11 || $[39] !== t12 || $[40] !== tone ? (t13 = (0, import_jsx_runtime3.jsx)(Banner, { tone, content: t11, action: t12 }), $[38] = t11, $[39] = t12, $[40] = tone, $[41] = t13) : t13 = $[41], t13;
}
...
function ScheduledReleaseBanner(t0) {
  ...
  let t5;
  $[7] !== t4 || $[8] !== tCore ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: tCore, i18nKey: "release.banner.scheduled-for-publishing-on", values: t4 }) }), $[7] = t4, $[8] = tCore, $[9] = t5) : t5 = $[9];
  let t6;
  return $[10] !== t5 || $[11] !== tone ? (t6 = (0, import_jsx_runtime3.jsx)(Banner, { tone, icon: LockIcon, content: t5 }), $[10] = t5, $[11] = tone, $[12] = t6) : t6 = $[12], t6;
}
...
var FormView = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(78), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react3.useState)(_temp$z), isLocked = editState?.transactionSyncLock?.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
  ...
  $[40] !== collapsedFieldSets || $[41] !== collapsedPaths || $[42] !== compareValue || $[43] !== connectionState || $[44] !== documentId || $[45] !== editState?.draft || $[46] !== editState?.published || $[47] !== fieldActions || $[48] !== formState || $[49] !== hasUpstreamVersion || $[50] !== hidden || $[51] !== inspectOpen || $[52] !== isReadOnly || $[53] !== onBlur || $[54] !== onChange || $[55] !== onFocus || $[56] !== onPathOpen || $[57] !== onSetActiveFieldGroup || $[58] !== onSetCollapsedFieldSet || $[59] !== onSetCollapsedPath || $[60] !== openPath || $[61] !== patchChannel || $[62] !== presence || $[63] !== selectedPerspective || $[64] !== t2 || $[65] !== title || $[66] !== validation ? (t13 = connectionState === "connecting" && !editState?.draft && !editState?.published ? (0, import_jsx_runtime3.jsx)(Delay, { ms: 300, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
    ...
    (0, import_jsx_runtime3.jsx)(FormRow, { children: (0, import_jsx_runtime3.jsx)(FormHeader, { documentId, schemaType: formState.schemaType, title }) }),
    (0, import_jsx_runtime3.jsx)(FormBuilder, { __internal_fieldActions: fieldActions, __internal_inspectOpen: inspectOpen, __internal_patchChannel: patchChannel, changed: formState.changed, collapsedFieldSets, collapsedPaths, compareValue: compareValue ?? void 0, focused: formState.focused, focusPath: formState.focusPath, groups: formState.groups, id: "root", members: formState.members, onChange, onFieldGroupSelect: onSetActiveFieldGroup, onPathBlur: onBlur, onPathFocus: onFocus, onPathOpen, onSetFieldSetCollapsed: onSetCollapsedFieldSet, onSetPathCollapsed: onSetCollapsedPath, openPath, perspective: selectedPerspective, hasUpstreamVersion, presence, readOnly: isReadOnly, schemaType: formState.schemaType, validation, value: formState.value })
  ] }), $[40] = collapsedFieldSets, $[41] = collapsedPaths, $[42] = compareValue, $[43] = connectionState, $[44] = documentId, $[45] = editState?.draft, $[46] = editState?.published, $[47] = fieldActions, $[48] = formState, $[49] = hasUpstreamVersion, $[50] = hidden, $[51] = inspectOpen, $[52] = isReadOnly, $[53] = onBlur, $[54] = onChange, $[55] = onFocus, $[56] = onPathOpen, $[57] = onSetActiveFieldGroup, $[58] = onSetCollapsedFieldSet, $[59] = onSetCollapsedPath, $[60] = openPath, $[61] = patchChannel, $[62] = presence, $[63] = selectedPerspective, $[64] = t2, $[65] = title, $[66] = validation, $[67] = t13) : t13 = $[67];
  let t14;
  $[68] !== setRef || $[69] !== t12 || $[70] !== t13 ? (t14 = (0, import_jsx_runtime3.jsx)(Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t12, children: t13 }), $[68] = setRef, $[69] = t12, $[70] = t13, $[71] = t14) : t14 = $[71];
  let t15;
  $[72] !== margins || $[73] !== t14 ? (t15 = (0, import_jsx_runtime3.jsx)(PresenceOverlay, { margins, children: t14 }), $[72] = margins, $[73] = t14, $[74] = t15) : t15 = $[74];
  let t16;
  return $[75] !== hidden || $[76] !== t15 ? (t16 = (0, import_jsx_runtime3.jsx)(FormContainer, { hidden, children: t15 }), $[75] = hidden, $[76] = t15, $[77] = t16) : t16 = $[77], t16;
});
  ...
  if ($[0] !== currentPaneIndex || $[1] !== paneDataItems) {
    ...
    $[3] !== currentPaneIndex ? (t22 = (paneData, idx) => {
      ...
      return (0, import_jsx_runtime3.jsxs)(import_react3.Fragment, { children: [
        ...
        idx < currentPaneIndex && (isDocumentPane2 ? (0, import_jsx_runtime3.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime3.jsx)(ArrowRightIcon, {}) }) : (0, import_jsx_runtime3.jsx)(Text, { children: "/" }))
...
var DocumentPanel = function(props) {
  ...
  const activeViewNode = t3, prevDocumentIdRef = (0, import_react3.useRef)(void 0);
  let t4, t5;
  ...
  }, t5 = [documentId, documentScrollElement], $[19] = documentId, $[20] = documentScrollElement, $[21] = t4, $[22] = t5) : (t4 = $[21], t5 = $[22]), (0, import_react3.useEffect)(t4, t5);
  let t6, t7;
  $[23] !== portalElement || $[24] !== setDocumentPanelPortalElement ? (t6 = () => {
    portalElement && setDocumentPanelPortalElement(portalElement);
  }, t7 = [portalElement, setDocumentPanelPortalElement], $[23] = portalElement, $[24] = setDocumentPanelPortalElement, $[25] = t6, $[26] = t7) : (t6 = $[25], t7 = $[26]), (0, import_react3.useEffect)(t6, t7);
  let t8;
  $[27] !== displayed || $[28] !== isInspectOpen || $[29] !== value ? (t8 = isInspectOpen ? (0, import_jsx_runtime3.jsx)(LegacyLayerProvider, { zOffset: "inspectorDialog", children: (0, import_jsx_runtime3.jsx)(InspectDialog, { value: displayed || value }) }) : null, $[27] = displayed, $[28] = isInspectOpen, $[29] = value, $[30] = t8) : t8 = $[30];
  ...
  bb1: {
    if (params?.historyVersion) {
      let t123;
      $[35] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t123 = (0, import_jsx_runtime3.jsx)(ArchivedReleaseDocumentBanner, {}), $[35] = t123) : t123 = $[35], t11 = t123;
      break bb1;
    }
    let t122;
    ...
    if (!isSystemBundle(selectedPerspective) && displayed?._id && getVersionFromId(displayed._id) !== selectedPerspectiveName && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === false && !isCurrentVersionGoingToUnpublish) {
      let t162;
      $[57] !== isScheduledRelease || $[58] !== selectedPerspective || $[59] !== value._id ? (t162 = (0, import_jsx_runtime3.jsx)(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: selectedPerspective, isScheduledRelease }), $[57] = isScheduledRelease, $[58] = selectedPerspective, $[59] = value._id, $[60] = t162) : t162 = $[60], t11 = t162;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t162;
        $[61] !== displayed || $[62] !== documentId || $[63] !== schemaType ? (t162 = (0, import_jsx_runtime3.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[61] = displayed, $[62] = documentId, $[63] = schemaType, $[64] = t162) : t162 = $[64], t11 = t162;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t162;
        $[65] !== displayed || $[66] !== documentId || $[67] !== schemaType ? (t162 = (0, import_jsx_runtime3.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: true }), $[65] = displayed, $[66] = documentId, $[67] = schemaType, $[68] = t162) : t162 = $[68], t11 = t162;
        break bb1;
      }
    }
  ...
  let t13;
  $[94] !== activeViewNode || $[95] !== banners || $[96] !== documentScrollElement || $[97] !== footer || $[98] !== formViewHidden || $[99] !== inspectDialog || $[100] !== layoutCollapsed || $[101] !== margins || $[102] !== portalElement || $[103] !== portalElements || $[104] !== showFormView ? (t13 = showFormView && (0, import_jsx_runtime3.jsxs)(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t14;
  $[106] !== documentId || $[107] !== rootElement || $[108] !== schemaType || $[109] !== showInspector ? (t14 = showInspector && (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: rootElement, children: (0, import_jsx_runtime3.jsx)(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[106] = documentId, $[107] = rootElement, $[108] = schemaType, $[109] = showInspector, $[110] = t14) : t14 = $[110];
  let t15;
  return $[111] !== t13 || $[112] !== t14 ? (t15 = (0, import_jsx_runtime3.jsx)(PaneContent, { children: (0, import_jsx_runtime3.jsxs)(Flex, { height: "fill", children: [
    t13,
    t14
...
function NonReleaseVersionsSelect(props) {
  ...
  $[7] !== documentType || $[8] !== getVersionDisplay || $[9] !== onCopyToDraftsNavigate || $[10] !== onSelectBundle || $[11] !== releases || $[12] !== releasesLoading || $[13] !== selectedNonReleaseVersion ? (t4 = selectedNonReleaseVersion && (() => {
    ...
    return (0, import_jsx_runtime3.jsx)(VersionChip$1, { selected: true, text: versionDisplay?.displayName ?? bundleId, tone: versionDisplay?.tone ?? "default", onClick: () => onSelectBundle(bundleId), onCopyToDraftsNavigate, contextValues: {
  ...
  let t5;
  $[15] !== nonReleaseDropdownOpen || $[16] !== otherNonReleaseVersions.length || $[17] !== t2 ? (t5 = otherNonReleaseVersions.length > 0 ? (0, import_jsx_runtime3.jsx)(Tooltip, { content: t2("release.chip.tooltip.other-versions", {
  ...
  if ($[19] !== documentType || $[20] !== getVersionDisplay || $[21] !== onCopyToDraftsNavigate || $[22] !== onSelectBundle || $[23] !== otherNonReleaseVersions || $[24] !== releases || $[25] !== releasesLoading || $[26] !== selectedPerspective) {
    ...
    $[28] !== documentType || $[29] !== getVersionDisplay || $[30] !== onCopyToDraftsNavigate || $[31] !== onSelectBundle || $[32] !== releases || $[33] !== releasesLoading || $[34] !== selectedPerspective ? (t72 = (nonReleaseVersionId) => {
      ...
      return (0, import_jsx_runtime3.jsx)(VersionChip$1, { selected, text: versionDisplay_0?.displayName ?? bundle, disabled: false, contextMenuPortal: false, tone: versionDisplay_0?.tone ?? "default", onClick: () => onSelectBundle(bundle), onCopyToDraftsNavigate, contextValues: {
    ...
    t6 = $[27];
  let t7;
  $[36] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Container, { width: 1, children: (0, import_jsx_runtime3.jsx)(Flex, { width: 1, padding: 3, gap: 2, wrap: "wrap", children: t6 }) }), $[36] = t6, $[37] = t7) : t7 = $[37];
  let t8;
  $[38] !== nonReleaseDropdownOpen || $[39] !== popoverReferenceElement || $[40] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(Popover2, { animate: false, open: nonReleaseDropdownOpen, portal: true, arrow: true, ref: popoverRef, placement: "bottom", referenceElement: popoverReferenceElement, zOffset: 10, content: t7 }), $[38] = nonReleaseDropdownOpen, $[39] = popoverReferenceElement, $[40] = t7, $[41] = t8) : t8 = $[41];
  let t9;
  return $[42] !== t4 || $[43] !== t5 || $[44] !== t8 ? (t9 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t4,
    t5,
    t8
...
var TooltipContent$1 = (t0) => {
  ...
  if (release.metadata.releaseType === "scheduled") {
    ...
    let t1;
    return $[8] !== formatPublishDate || $[9] !== isActive || $[10] !== release || $[11] !== t2 ? (t1 = release.metadata.intendedPublishAt && (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: isActive ? (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.intended-for-date", values: {
  ...
  if (release.metadata.releaseType === "undecided") {
    ...
    let t22;
    return $[15] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: t1 }), $[15] = t1, $[16] = t22) : t22 = $[16], t22;
  }
  return null;
};
...
var DocumentPerspectiveList = (0, import_react3.memo)(function() {
  ...
  let t23;
  $[98] !== documentType || $[99] !== filteredReleases.notCurrentReleases || $[100] !== getVersionDisplay || $[101] !== handleCopyToDraftsNavigate || $[102] !== handlePerspectiveChange || $[103] !== loading || $[104] !== nonReleaseVersions || $[105] !== selectedPerspectiveName ? (t23 = (0, import_jsx_runtime3.jsx)(NonReleaseVersionsSelect, { nonReleaseVersions, selectedPerspective: selectedPerspectiveName, onSelectBundle: handlePerspectiveChange, onCopyToDraftsNavigate: handleCopyToDraftsNavigate, releases: filteredReleases.notCurrentReleases, releasesLoading: loading, documentType, getVersionDisplay }), $[98] = documentType, $[99] = filteredReleases.notCurrentReleases, $[100] = getVersionDisplay, $[101] = handleCopyToDraftsNavigate, $[102] = handlePerspectiveChange, $[103] = loading, $[104] = nonReleaseVersions, $[105] = selectedPerspectiveName, $[106] = t23) : t23 = $[106];
  let t24;
  return $[107] !== t19 || $[108] !== t20 || $[109] !== t21 || $[110] !== t222 || $[111] !== t23 ? (t24 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t19,
    t20,
    t21,
    t222,
...
var DocumentPanelHeader = (0, import_react3.memo)((0, import_react3.forwardRef)(function(_props, ref) {
  ...
  } = useFieldActions(), [referenceElement, setReferenceElement] = (0, import_react3.useState)(null), scrollContainerRef = (0, import_react3.useRef)(null), showGradient = useChipScrollPosition(scrollContainerRef), telemetry = useTelemetry(), zIndex = useZIndex(), paneHeaderZIndex = Array.isArray(zIndex.paneHeader) ? zIndex.paneHeader[1] : zIndex.paneHeader;
  let t0;
...
var useDuplicateAction = (t0) => {
  ...
  $[6] !== documentStore.pair || $[7] !== duplicate || $[8] !== id2 || $[9] !== mapDocument || $[10] !== navigateIntent || $[11] !== type2 ? (t32 = async () => {
    ...
    setDuplicating(true);
    const duplicateSuccess = firstValueFrom(documentStore.pair.operationEvents(id2, type2).pipe(filter(_temp$r)));
...
function DocumentStatusLine() {
  const $ = (0, import_compiler_runtime2.c)(18), {
    ...
    documentId,
    documentType
  } = useDocumentPaneInfo(), [status, setStatus] = (0, import_react3.useState)(null), eventsEnabled = useSource().beta?.eventsAPI?.documents, syncState = useSyncState(documentId, documentType, editState?.release), lastUpdated = value?._updatedAt;
  let t0;
...
function DocumentStatusBar(props) {
  const $ = (0, import_compiler_runtime2.c)(17), {
    ...
    selectedPerspective
  } = usePerspective(), showingRevision = !!params.rev, [collapsed, setCollapsed] = (0, import_react3.useState)(null), [rootElement, setRootElement] = (0, import_react3.useState)(null);
  let t1;
  ...
  if (showingRevision) {
    let t42;
    $[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime3.jsx)(HistoryStatusBarActions, {}), $[3] = t42) : t42 = $[3], actions = t42;
  } else {
    let t42;
    $[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime3.jsx)(DocumentStatusBarActions, {}), $[4] = t42) : t42 = $[4], actions = t42;
  }
  ...
  let t8;
  $[7] !== actions || $[8] !== actionsBoxRef || $[9] !== collapsed || $[10] !== shouldRender || $[11] !== showingRevision ? (t8 = shouldRender && (0, import_jsx_runtime3.jsxs)(Flex, { align: "stretch", gap: 1, justify: "space-between", paddingLeft: showingRevision ? 0 : 1, paddingRight: showingRevision ? 0 : 1, children: [
  ...
  let t9;
  return $[13] !== t4 || $[14] !== t7 || $[15] !== t8 ? (t9 = (0, import_jsx_runtime3.jsx)(AnimatedCard, { initial: t5, animate: t6, tone: t7, radius: 3, ref: setRootElement, sizing: "border", padding: 2, children: t8 }, t4), $[13] = t4, $[14] = t7, $[15] = t8, $[16] = t9) : t9 = $[16], t9;
}
...
function DocumentLayoutFooter(t0) {
  ...
  let t2;
  $[2] !== setActionsBoxElement ? (t2 = (0, import_jsx_runtime3.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime3.jsx)(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement }) }), $[2] = setActionsBoxElement, $[3] = t2) : t2 = $[3];
  let t3;
  $[4] !== setFooterElement || $[5] !== t2 ? (t3 = (0, import_jsx_runtime3.jsx)(PaneFooter, { ref: setFooterElement, padding: 1, children: t2 }), $[4] = setFooterElement, $[5] = t2, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== t3 || $[8] !== zOffsets.portal ? (t4 = (0, import_jsx_runtime3.jsx)(DialogProvider, { position: DIALOG_PROVIDER_POSITION$1, zOffset: zOffsets.portal, children: t3 }), $[7] = t3, $[8] = zOffsets.portal, $[9] = t4) : t4 = $[9];
  let t5;
  return $[10] !== portalElements || $[11] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(PortalProvider, { __unstable_elements: portalElements, children: t4 }), $[10] = portalElements, $[11] = t4, $[12] = t5) : t5 = $[12], t5;
}
var EMPTY_ARRAY$1 = [];
...
var DocumentTitle = (t0) => {
  ...
  let t5;
  return $[15] !== documentTitle || $[16] !== newTitle || $[17] !== previewValueIsLoading || $[18] !== ready ? (t5 = [documentTitle, ready, newTitle, previewValueIsLoading], $[15] = documentTitle, $[16] = newTitle, $[17] = previewValueIsLoading, $[18] = ready, $[19] = t5) : t5 = $[19], (0, import_react3.useEffect)(t4, t5), null;
};
var PassthroughTitle = (props) => {
  ...
  let t1;
  return $[2] !== newTitle || $[3] !== title ? (t1 = [newTitle, title], $[2] = newTitle, $[3] = title, $[4] = t1) : t1 = $[4], (0, import_react3.useEffect)(t0, t1), null;
};
var StructureTitle = (props) => {
  ...
  if (isLoadingPane(lastPane)) {
    let t02;
    return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime3.jsx)(PassthroughTitle, {}), $[0] = t02) : t02 = $[0], t02;
  }
  if (isDocumentPane(lastPane)) {
    if (lastPane?.title) {
      let t02;
      return $[1] !== lastPane.title ? (t02 = (0, import_jsx_runtime3.jsx)(PassthroughTitle, { title: lastPane.title }), $[1] = lastPane.title, $[2] = t02) : t02 = $[2], t02;
    }
    return null;
  }
  const t0 = lastPane?.title;
  let t1;
  return $[3] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(PassthroughTitle, { title: t0 }), $[3] = t0, $[4] = t1) : t1 = $[4], t1;
};
...
var useDeletedDocumentLastRevision = () => {
  const $ = (0, import_compiler_runtime2.c)(3), {
    revision
  } = (0, import_react3.useContext)(EventsContext) || EventsContextFallback, t0 = revision?.document || null, t1 = revision?.loading || false;
  let t2;
  return $[0] !== t0 || $[1] !== t1 ? (t2 = {
...
function useDocumentInitialLoadTelemetry(t0) {
  const $ = (0, import_compiler_runtime2.c)(9), {
    ...
    editState,
    hasRevisionParam
  } = t0, telemetry = useTelemetry(), t0Ref = (0, import_react3.useRef)(null);
  let t1, t2;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = () => {
    t0Ref.current = performance.now();
  }, t2 = [], $[0] = t1, $[1] = t2) : (t1 = $[0], t2 = $[1]), (0, import_react3.useEffect)(t1, t2);
  const firedRef = (0, import_react3.useRef)(false);
  let t3, t4;
  ...
  }, t4 = [ready, telemetry, schemaTypeName, editState, hasRevisionParam], $[2] = editState, $[3] = hasRevisionParam, $[4] = ready, $[5] = schemaTypeName, $[6] = telemetry, $[7] = t3, $[8] = t4) : (t3 = $[7], t4 = $[8]), (0, import_react3.useEffect)(t3, t4);
}
...
function DocumentPaneProvider(props) {
  const $ = (0, import_compiler_runtime2.c)(248), {
    children,
    index,
    pane,
    paneKey,
  ...
  const {
    ...
    inspectOpen,
    handleLegacyInspectClose
  } = useDocumentPaneInspector(t14), [isDeleting, setIsDeleting] = (0, import_react3.useState)(false), {
    lastRevisionDocument
  ...
  }, t41 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[117] = documentId, $[118] = documentType, $[119] = onChange, $[120] = schemaType, $[121] = setDocumentMeta, $[122] = t40, $[123] = t41) : (t40 = $[122], t41 = $[123]), (0, import_react3.useEffect)(t40, t41);
  let t42;
  ...
  const documentPaneInfo = t48, pathRef = (0, import_react3.useRef)(void 0), paramPath = params.path;
  let t49;
  ...
  const syncPathFromUrl = (0, import_react3.useEffectEvent)(t49);
  let t50;
  ...
  let t51;
  $[220] !== paramPath || $[221] !== ready ? (t51 = [paramPath, ready], $[220] = paramPath, $[221] = ready, $[222] = t51) : t51 = $[222], (0, import_react3.useEffect)(t50, t51);
  const isDivergencesEnabled = !!(((0, import_react3.useContext)(DocumentDivergencesContext)?.enabled ?? advancedVersionControlEnabled) && formState && schemaType);
  let t52;
  ...
  let t53;
  $[230] !== onProgrammaticFocus ? (t53 = (0, import_jsx_runtime3.jsx)(DivergenceAutofocus, { onProgrammaticFocus }), $[230] = onProgrammaticFocus, $[231] = t53) : t53 = $[231];
  let t54;
  $[232] !== displayed || $[233] !== isDeleted_1 || $[234] !== ready || $[235] !== schemaType ? (t54 = (0, import_jsx_runtime3.jsx)(DocumentTitle, { isDeleted: isDeleted_1, displayed, ready, schemaType }), $[232] = displayed, $[233] = isDeleted_1, $[234] = ready, $[235] = schemaType, $[236] = t54) : t54 = $[236];
  let t55;
  $[237] !== children || $[238] !== divergencesProps || $[239] !== t53 || $[240] !== t54 ? (t55 = (0, import_jsx_runtime3.jsxs)(DivergencesProvider, { ...divergencesProps, children: [
    t53,
    t54,
    children
  ] }), $[237] = children, $[238] = divergencesProps, $[239] = t53, $[240] = t54, $[241] = t55) : t55 = $[241];
  let t56;
  $[242] !== documentPane || $[243] !== t55 ? (t56 = (0, import_jsx_runtime3.jsx)(DocumentPaneContext.Provider, { value: documentPane, children: t55 }), $[242] = documentPane, $[243] = t55, $[244] = t56) : t56 = $[244];
  let t57;
  return $[245] !== documentPaneInfo || $[246] !== t56 ? (t57 = (0, import_jsx_runtime3.jsx)(DocumentPaneInfoContext.Provider, { value: documentPaneInfo, children: t56 }), $[245] = documentPaneInfo, $[246] = t56, $[247] = t57) : t57 = $[247], t57;
}
...
var DivergenceAutofocus = (t0) => {
  ...
  const focusDivergentPath = (0, import_react3.useEffectEvent)(t1);
  let t2;
  $[4] !== focusDivergentPath ? (t2 = () => {
    focusDivergentPath();
  }, $[4] = focusDivergentPath, $[5] = t2) : t2 = $[5];
  let t3;
  return $[6] !== focusedDivergence ? (t3 = [focusedDivergence], $[6] = focusedDivergence, $[7] = t3) : t3 = $[7], (0, import_react3.useEffect)(t2, t3), null;
};
var DocumentEventsPane = (props) => {
  ...
  let t12;
  $[28] !== historyStoreProps || $[29] !== historyVersion || $[30] !== props ? (t12 = historyVersion ? (0, import_jsx_runtime3.jsx)(PerspectiveProvider, { selectedPerspectiveName: historyVersion, excludedPerspectives: EMPTY_ARRAY$y, children: (0, import_jsx_runtime3.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }) }) : (0, import_jsx_runtime3.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }), $[28] = historyStoreProps, $[29] = historyVersion, $[30] = props, $[31] = t12) : t12 = $[31];
  let t13;
  return $[32] !== t12 || $[33] !== value ? (t13 = (0, import_jsx_runtime3.jsx)(EventsProvider, { value, children: t12 }), $[32] = t12, $[33] = value, $[34] = t13) : t13 = $[34], t13;
};
var DocumentPaneWithLegacyTimelineStore = (props) => {
  const $ = (0, import_compiler_runtime2.c)(20), {
    pane
  } = props, paneRouter = usePaneRouter(), options = usePaneOptions(pane.options, paneRouter.params), params = paneRouter.params || EMPTY_PARAMS$2, [timelineError, setTimelineError] = (0, import_react3.useState)(null);
  let t0;
...
var paneMap = {
  component: (0, import_react3.lazy)(() => import("./index2-HQL7E7BM.js")),
  document: (0, import_react3.lazy)(() => import("./pane-JOMSCXSI.js")),
  documentList: (0, import_react3.lazy)(() => import("./pane2-CEFIH7VA.js")),
  list: (0, import_react3.lazy)(() => import("./index3-B7RRIFH3.js"))
};
...
var VersionItemPreview = (t0) => {
  ...
  let t11;
  $[27] !== documentVariant || $[28] !== release?.metadata?.title || $[29] !== systemTitle || $[30] !== versionId ? (t11 = documentVariant === "version" ? (0, import_jsx_runtime3.jsx)(ReleaseTitle, { title: release?.metadata?.title, fallback: getVersionFromId(versionId), children: _temp$g }) : (0, import_jsx_runtime3.jsx)(EllipsisText, { size: 1, weight: "medium", textOverflow: "ellipsis", children: systemTitle }), $[27] = documentVariant, $[28] = release?.metadata?.title, $[29] = systemTitle, $[30] = versionId, $[31] = t11) : t11 = $[31];
  let t12;
...
function ConfirmDeleteDialogBody(t0) {
  ...
  $[43] !== crossDatasetReferences || $[44] !== datasetSubtitle || $[45] !== documentId || $[46] !== internalReferences.totalCount || $[47] !== normalizedDatasetNames.length || $[48] !== t2 || $[49] !== toast ? (t18 = crossDatasetReferences.totalCount > 0 && (0, import_jsx_runtime3.jsxs)(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    ...
    (0, import_jsx_runtime3.jsxs)(Box, { overflow: "auto", paddingTop: 2, children: [
      (0, import_jsx_runtime3.jsxs)(Table, { children: [
        ...
        (0, import_jsx_runtime3.jsx)("tbody", { children: crossDatasetReferences.references.filter(_temp$f).map((t192, index) => {
          const {
            projectId,
            datasetName,
...
function PaneHeaderCreateButton(t0) {
  ...
  if (templateItems.length === 1) {
    ...
    let t9;
    $[26] !== disabled || $[27] !== intent || $[28] !== t52.title || $[29] !== t82 ? (t9 = (0, import_jsx_runtime3.jsx)(IntentButton, { "aria-label": t62, icon: AddIcon, intent, mode: "bleed", disabled, "data-testid": "action-intent-button", tooltipProps: t82 }), $[26] = disabled, $[27] = intent, $[28] = t52.title, $[29] = t82, $[30] = t9) : t9 = $[30];
    let t10;
    return $[31] !== disabled || $[32] !== isTemplatePermissionsLoading || $[33] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessageTooltip, { reveal: disabled, loading: isTemplatePermissionsLoading, context: "create-document-type", children: t9 }), $[31] = disabled, $[32] = isTemplatePermissionsLoading, $[33] = t9, $[34] = t10) : t10 = $[34], t10;
  }
  let t4;
  $[35] !== t2 ? (t4 = t2("pane-header.create-new-button.tooltip"), $[35] = t2, $[36] = t4) : t4 = $[36];
  let t5;
  $[37] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Button2, { icon: AddIcon, mode: "bleed", "data-testid": "multi-action-intent-button", tooltipProps: {
    content: t4
  } }), $[37] = t4, $[38] = t5) : t5 = $[38];
  let t6;
  if ($[39] !== getI18nText || $[40] !== isTemplatePermissionsLoading || $[41] !== permissionsById || $[42] !== selectedReleaseId || $[43] !== t2 || $[44] !== templateItems || $[45] !== templates) {
    ...
    t6 = $[46];
  let t7;
  $[54] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Menu, { children: t6 }), $[54] = t6, $[55] = t7) : t7 = $[55];
  let t8;
  return $[56] !== t5 || $[57] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(MenuButton, { button: t5, id: "create-menu", menu: t7, popover: POPOVER_PROPS }), $[56] = t5, $[57] = t7, $[58] = t8) : t8 = $[58], t8;
}
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t22 || $[14] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(SanityDefaultPreview, { title: t22, subtitle: t5, media: _temp$b, layout }), $[12] = layout, $[13] = t22, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$b() {
...
function listenSearchQuery(options) {
  ...
  return merge(welcome$, mutationAndReconnect$.pipe(throttleTime(1e3, asyncScheduler, {
    ...
    const types = getSearchableTypes(schema, staticTypeNames || []).filter((type2) => {
      if (typeNames.includes(type2.name)) {
        for (const entry of sort.by)
          entry.field && compileFieldPath(type2, entry.field, {
            strict: true
          });
        return true;
      }
...
function useDocumentList(opts) {
  ...
  const typeNameFromFilter = t0, [t1] = (0, import_react3.useState)(_temp$8), [onRetry$, onRetry] = t1, [t2] = (0, import_react3.useState)(_temp2$5), [onFetchFullList$, onLoadFullList] = t2, t3 = searchQuery || "", t4 = sortOrder || DEFAULT_ORDERING;
  let t5;
  ...
  let t6;
  return $[23] !== autoRetry_0 || $[24] !== canRetry_0 || $[25] !== connected || $[26] !== error_0 || $[27] !== fromCache || $[28] !== isLoading || $[29] !== isLoadingFullList || $[30] !== isRetrying || $[31] !== items2 || $[32] !== onLoadFullList || $[33] !== onRetry || $[34] !== retryCount_0 ? (t6 = {
    error: error_0,
    onRetry,
    isLoading,
    items: items2,
    ...
    onLoadFullList,
    isLoadingFullList
  }, $[23] = autoRetry_0, $[24] = canRetry_0, $[25] = connected, $[26] = error_0, $[27] = fromCache, $[28] = isLoading, $[29] = isLoadingFullList, $[30] = isRetrying, $[31] = items2, $[32] = onLoadFullList, $[33] = onRetry, $[34] = retryCount_0, $[35] = t6) : t6 = $[35], t6;
}
...
var DocumentListPane = (0, import_react3.memo)(function(props) {
  ...
  const typeName = t0, showIcons = displayOptions?.showIcons !== false, {
    ...
    title
  } = useI18nText(pane), [searchQuery, setSearchQuery] = (0, import_react3.useState)(""), [searchInputValue, setSearchInputValue] = (0, import_react3.useState)(""), [searchInputElement, setSearchInputElement] = (0, import_react3.useState)(null);
  let t1;
...
var PaneContainer = (0, import_react3.memo)(function(props) {
  ...
  const [customMenuItemState, setCustomMenuItemState] = (0, import_react3.useState)(t9);
  let t10;
  ...
  let t15;
  $[33] !== customMenuItemState || $[34] !== handleSetSortOrder || $[35] !== index || $[36] !== initialValueTemplates || $[37] !== menuItemGroups || $[38] !== menuItemsWithSelectedState || $[39] !== setLayout || $[40] !== title ? (t15 = (0, import_jsx_runtime3.jsx)(PaneHeader, { customMenuItemState, index, initialValueTemplates, menuItemGroups, menuItems: menuItemsWithSelectedState, setLayout, setSortOrder: handleSetSortOrder, setCustomMenuItemState, title }), $[33] = customMenuItemState, $[34] = handleSetSortOrder, $[35] = index, $[36] = initialValueTemplates, $[37] = menuItemGroups, $[38] = menuItemsWithSelectedState, $[39] = setLayout, $[40] = title, $[41] = t15) : t15 = $[41];
  let t16;
  $[42] !== layout || $[43] !== props || $[44] !== validatedSortOrder ? (t16 = (0, import_jsx_runtime3.jsx)(DocumentListPane, { ...props, sortOrder: validatedSortOrder, layout }), $[42] = layout, $[43] = props, $[44] = validatedSortOrder, $[45] = t16) : t16 = $[45];
  let t17;
  $[46] !== isSelected || $[47] !== paneKey || $[48] !== t14 || $[49] !== t15 || $[50] !== t16 ? (t17 = (0, import_jsx_runtime3.jsxs)(Pane, { "data-ui": "DocumentListPane", id: paneKey, minWidth: 320, currentMaxWidth: 350, maxWidth: 640, selected: isSelected, children: [
    t14,
    t15,
    t16
  ] }), $[46] = isSelected, $[47] = paneKey, $[48] = t14, $[49] = t15, $[50] = t16, $[51] = t17) : t17 = $[51];
  let t18;
  return $[52] !== t13 || $[53] !== t17 ? (t18 = (0, import_jsx_runtime3.jsx)(SourceProvider, { name: t13, children: t17 }), $[52] = t13, $[53] = t17, $[54] = t18) : t18 = $[54], t18;
});
...
function IncomingReferencesList() {
  ...
  let t4;
  $[12] !== showEmptyState || $[13] !== t2 ? (t4 = showEmptyState && (0, import_jsx_runtime3.jsx)(Card, { border: true, radius: 3, padding: 1, tone: "default", children: (0, import_jsx_runtime3.jsx)(Box, { paddingY: 3, paddingX: 2, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: t2("incoming-references-pane.no-references") }) }) }), $[12] = showEmptyState, $[13] = t2, $[14] = t4) : t4 = $[14];
  let t5;
  $[15] !== emptyMessage || $[16] !== references?.list || $[17] !== references?.loading || $[18] !== renderSameDatasetItem || $[19] !== t2 ? (t5 = references?.loading ? (0, import_jsx_runtime3.jsx)(LoadingBlock, { showText: true, title: t2("incoming-references-input.types-loading") }) : references?.list.map((t62) => {
    const {
      type: type_3,
  ...
  let t6;
  $[21] !== crossDatasetRefs?.list || $[22] !== crossDatasetRefs?.loading || $[23] !== emptyMessage || $[24] !== t2 ? (t6 = crossDatasetRefs?.loading ? (0, import_jsx_runtime3.jsx)(LoadingBlock, { showText: true, title: t2("incoming-references-input.types-loading-cross-dataset") }) : crossDatasetRefs?.list.map((t72) => {
    const {
      type: type_4,
  ...
  let t7;
  return $[26] !== t4 || $[27] !== t5 || $[28] !== t6 ? (t7 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t4,
    t5,
    t6
...
function ValidationCard(props) {
  ...
  const handleClick = t0, [errorInfo, setErrorInfo] = (0, import_react3.useState)(null), Icon = MARKER_ICON[marker.level];
  let t1;
  ...
  let t2;
  $[5] !== Icon || $[6] !== errorInfo || $[7] !== handleClick || $[8] !== marker.level || $[9] !== marker.message || $[10] !== marker.path || $[11] !== schemaType || $[12] !== value ? (t2 = !errorInfo && (0, import_jsx_runtime3.jsx)(Card, { __unstable_focusRing: true, as: "button", onClick: handleClick, padding: 3, radius: 2, style: {
    userSelect: "text"
  }, tone: MARKER_TONE[marker.level], children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "flex-start", gap: 3, children: [
...
function encodeChunks(pane, index, group) {
  const {
    ...
    params = {},
    id: id2
  } = pane, [firstSibling] = group, paneIsFirstSibling = pane === firstSibling, sameAsFirst = index !== 0 && id2 === firstSibling.id, encodedPayload = typeof payload > "u" ? void 0 : encodeJsonParams(payload), encodedParams = Object.entries(params).filter((entry) => {
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react3.lazy)(() => import("./index4-NMGA5NKA.js")),
...
//# sourceMappingURL=chunk-I3TULIUB.js.map
